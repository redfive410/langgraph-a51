...
def ask_question(state: State):
    ...
    messages = [
        SystemMessage(content="You are playing 20 Questions. You need to guess the object that the other AI is thinking of. Only respond with the question."),
...
def answer_question(state: State):
    ...
    messages = [
        SystemMessage(content="You are playing 20 Questions. You need to answer Yes or No."),
        HumanMessage(content=prompt)
    ]
...
def make_guess(state: State):
    ...
    messages = [
        SystemMessage(content="You are playing 20 Questions. Only answer with the name of the item."),
        HumanMessage(content=prompt)
    ]
...
def check_game_over(state: State):
    ...
    messages = [
        SystemMessage(content="You are the judge of 20 questions. Please answer with Yes or No."),
        HumanMessage(content=prompt)
    ]
